            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Подбор тура для новых путешественников начинается после внесения возвратного депозита <strong>69,90 &euro;</strong>.
                  При бронировании тура депозит вам полностью возвращается тем же способом оплаты.
                  Если после проведённой работы вы отказываетесь от бронирования, депозит остаётся как оплата консультации.
                </p>
                <a
