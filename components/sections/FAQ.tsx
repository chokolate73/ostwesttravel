...
const faqData: FAQCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "69,90 \u20ac для новых путешественников.",
      },
      {
        id: "faq-deposit-return",
        q: "Депозит возвращается?",
        a: "Да. При бронировании тура депозит полностью возвращается вам.",
      },
      {
        id: "faq-deposit-how",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Да, по вашему желанию подбираю страховые решения.",
      },
      {
        id: "faq-book-support",
        q: "Вы на связи во время поездки?",
        a: "Да, сопровождаю вас до, во время и после путешествия.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "В основном с русскоязычными туристами, проживающими в Германии и Европе.",
      },
      {
        id: "faq-gen-free",
