        ...
        {showPaymentChoice ? (
          <ScrollReveal>
            <div className="bg-white rounded-2xl p-8 md:p-12 text-center shadow-sm">
              ...
              <p className="text-sm text-gray-400 mt-2 text-center">Депозит возвращается после бронирования путешествия. <a href="#faq-deposit-why" className="text-gold hover:text-gold-dark underline">Подробнее</a></p>
            </div>
          </ScrollReveal>
        ) : submitted ? (
          <ScrollReveal>
