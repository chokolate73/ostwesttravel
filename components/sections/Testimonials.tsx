...
const testimonials = [
  ...
  {
    text: 'Брали круиз по Норвежским фьордам - зрелище невероятное 🏔️ Василя посоветовала каюту именно по правому борту, чтобы видеть лучшие виды. Такое внимание к деталям дорогого стоит!',
