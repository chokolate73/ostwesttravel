            ...
            <address className="not-italic">
              <ul className="space-y-3 text-white/50 text-sm">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a href="tel:+4922127253591" className="hover:text-white transition-colors whitespace-nowrap">+49 221 27253591</a>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>Franz-Xaver-Mauer-Straße 34, 50374 Erftstadt, Germany</span>
                </li>
              </ul>
            </address>
          </div>
